        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">
              {step === 1 ? "Start your English learning journey with Kira" : "Enter the code sent to your email"}
            </CardDescription>
          </CardHeader>
              ...
              <form onSubmit={handleRequestEmail} className="space-y-4">
                ...
                {formData.isAdmin && (
                  <div className="space-y-2">
                    ...
                    <Input id="employeeCode" name="employeeCode" value={formData.employeeCode} onChange={handleChange} required={formData.isAdmin} />
                  </div>
                )}
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox id="terms" name="terms" required checked={formData.terms} onCheckedChange={(checked) => setFormData(prev => ({ ...prev, terms: checked as boolean }))} />
            ...
            {step === 2 && (
              <form onSubmit={handleFinalSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="code" name="code" required value={verificationCode} onChange={e => setVerificationCode(e.target.value)} />
                </div>
